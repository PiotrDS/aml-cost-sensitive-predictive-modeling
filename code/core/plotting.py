...
def plot_probability_distribution(
    y_true, probs, title, output_dir, filename="prob_distribution.png"
):
    ...
    sns.kdeplot(
        probs_pos, fill=True, color="#2ca02c", label="Class 1 (Conversion)", alpha=0.4
    )
...
def plot_profit_optimization_curve(
    ...
    best_x,
    output_dir,
    filename="profit_optimization.png",
):
...
def plot_lasso_sweep(
    ...
    ax1.set_title(
        "Profit vs. L1 Regularization Strength (Nested MI)", fontsize=13, pad=10
    )
    ax1.legend()
